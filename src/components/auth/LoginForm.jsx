...
// //                 >
// //                   <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-purple-100 text-lg">
// //                     👨‍⚕️
// //                   </div>
...
// //                   disabled={demoLoading}
// //                   className="flex items-center gap-3 rounded-xl border border-[#f3cbd2] bg-[#fff1f3] px-4 py-3 text-left transition hover:border-[#d92745] hover:bg-[#ffe6eb] disabled:opacity-60"
// //                 >
// //                   <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#f7dce1] text-lg">
// //                     🛡️
// //                   </div>
...
// //                   <span className="font-bold">Demo Admin:</span> This account is
// //                   for demonstration purposes only. It cannot create or assign
...
// //         <button
// //           type="button"
// //           className="mt-3 flex w-full items-center justify-center gap-3 rounded-xl border border-gray-200 py-3 font-semibold transition hover:bg-gray-50"
// //         >
// //           <FcGoogle className="text-xl" />
// //           Continue with Google
// //         </button>
