...
export default function PatientDocuments() {
  ...
  // ✅ হেলপার ফাংশন: ফাইলকে Base64 String-এ রূপান্তর করে
  ...
  const handleSubmit = async () => {
    ...
    try {
      // ✅ আসল ফাইলকে Base64 String এ রূপান্তর করা হচ্ছে (blob বাদ দিয়ে)
      const base64FileData = await convertToBase64(files[0]);
      ...
      const res = await fetch("/api/patient/documents", {
        ...
        body: JSON.stringify({
          patientId: user._id,
          doctorId: selectedDoctor,
          documentUrl: base64FileData, // 👈 আসল ফাইল ডাটা পাঠানো হচ্ছে
          documentName: files[0].name,
          notes,
        }),
      });
